    ...
    >
      <div className="flex justify-between items-center w-full h-full px-2 2xl:px-16">
        ...
        <div>
          ...
          {/* Hamburger Icon */}
          <div className="md:hidden flex justify-between items-center w-20">
            {renderThemeChanges()}
      ...
      >
        ...
        <div
          className={
            nav
              ? " fixed left-0 top-0 w-[75%] sm:w-[60%] md:w-[45%] h-screen bg-[#ffffff]  dark:bg-[#181818] p-10 ease-in duration-500"
