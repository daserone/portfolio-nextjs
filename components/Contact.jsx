...
const Contact = () => {
  ...
  const formSubmit = (e) => {
    ...
    fetch("https://getform.io/f/8c13fa93-d6b4-4fbc-a0b5-54fc7d6003e1", {
      method: "POST",
      body: formData,
    }).then(() =>
      setQuery({ name: "", email: "", phone: "", subject: "", message: "" })
    );
  };
  return (
    <div id="contact" className="w-full lg:h-screen">
      <div className="max-w-[1240px] m-auto px-2 py-16 w-full ">
        ...
        <div className="flex justify-center py-12">
          <Link href="/">
            <a>
              <div className="rounded-full shadow-lg shadow-gray-400 dark:shadow-gray-900 p-4 cursor-pointer hover:scale-110 ease-in duration-300">
